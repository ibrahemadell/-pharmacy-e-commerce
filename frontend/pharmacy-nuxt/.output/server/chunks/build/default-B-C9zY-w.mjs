...
import { a as useCart, b as useCartStore, c as useFormatters } from './index-BKk0TMm7.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", __props.item.productImage || "/img/placeholder.png")}${ssrRenderAttr("alt", __props.item.productName)} class="w-16 h-16 rounded-lg object-cover bg-gray-50"${_scopeId}>`);
          } else {
            return [
              createVNode("img", {
...
//# sourceMappingURL=default-B-C9zY-w.mjs.map
