import { g as useRoute, h as useRouter, f as useHead, a as __nuxt_component_1, _ as __nuxt_component_0 } from './server.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(form).imageUrls.length) {
        ...
        ssrRenderList(unref(form).imageUrls, (url, i) => {
          _push(`<div class="relative group aspect-square"><img${ssrRenderAttr("src", url)} class="w-full h-full object-contain rounded-lg border border-gray-200 dark:border-slate-600 bg-gray-50"><button type="button" class="absolute -top-1.5 -right-1.5 w-5 h-5 bg-red-500 text-white rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">`);
          _push(ssrRenderComponent(_component_Icon, {
...
//# sourceMappingURL=edit-Dz22Evtr.mjs.map
