...
import { o as hasProtocol, p as isScriptProtocol, r as joinURL, s as klona, t as parseQuery, B as withQuery, v as sanitizeStatusCode, u as parseURL, h as encodePath, d as decodePath, f as defuFn, j as getContext, C as withTrailingSlash, D as withoutTrailingSlash, $ as $fetch, e as defu, a as createHooks, c as createError$1, i as executeAsync } from '../_/nitro.mjs';
...
const namedMiddleware = {
  admin: () => import('./admin-zq6E-0RP.mjs'),
  auth: () => import('./auth-C3tqdiZI.mjs')
};
...
const LazyIconCSS = defineAsyncComponent(() => import('./IconCSS-BHdH6wFo.mjs').then((r) => r["default"] || r.default || r));
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    useHead({
      titleTemplate: (title) => title ? title : "PharmaCare - Your Trusted Online Pharmacy",
      htmlAttrs: { lang: "en" },
      meta: [
        { name: "description", content: "PharmaCare — Quality medicines, vitamins & health products delivered to your door. Prescription handling made easy." },
        { property: "og:type", content: "website" },
        { property: "og:site_name", content: "PharmaCare" },
        { name: "robots", content: "index,follow" }
      ],
      link: [
        { rel: "canonical", href: "https://pharmacare.com" }
      ]
    });
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-e8d572f6"]]);
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen bg-white dark:bg-slate-900 flex items-center justify-center p-4" }, _attrs))}><div class="text-center max-w-md"><div class="w-24 h-24 bg-emerald-100 dark:bg-emerald-900 rounded-full flex items-center justify-center mx-auto mb-6">`);
      _push(ssrRenderComponent(_component_Icon, {
        name: __props.error?.statusCode === 404 ? "heroicons:magnifying-glass" : "heroicons:exclamation-triangle",
        class: "w-12 h-12 text-emerald-600"
      }, null, _parent));
      _push(`</div><h1 class="text-6xl font-bold text-emerald-600 mb-3">${ssrInterpolate(__props.error?.statusCode)}</h1><h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-2">${ssrInterpolate(__props.error?.statusCode === 404 ? "Page Not Found" : "Something went wrong")}</h2><p class="text-gray-500 mb-8">${ssrInterpolate(__props.error?.statusCode === 404 ? "The page you're looking for doesn't exist or has been moved." : __props.error?.message || "An unexpected error occurred.")}</p><div class="flex flex-col sm:flex-row gap-3 justify-center">`);
      ...
      _push(`<button class="btn-secondary"> Try Again </button></div></div></div>`);
    };
  }
});
