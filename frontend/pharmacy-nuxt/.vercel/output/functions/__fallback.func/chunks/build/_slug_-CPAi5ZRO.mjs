import { h as useRoute, a as __nuxt_component_1, _ as __nuxt_component_0, j as useRuntimeConfig } from './server.mjs';
import { _ as _sfc_main$1 } from './NuxtImg-BUTvnb3j.mjs';
import { _ as _sfc_main$2 } from './ProductCard-DgZLsjHy.mjs';
...
import { u as useApi, a as useCart, c as useFormatters } from './index-CDfwTiwy.mjs';
import '../_/nitro.mjs';
import 'node:http';
import 'node:https';
import 'node:events';
      ...
      if (unref(product)) {
        ...
        if (unref(product).images.length > 1) {
          ...
          ssrRenderList(unref(product).images, (img) => {
            _push(`<button class="${ssrRenderClass([unref(activeImage) === img.imageUrl ? "border-emerald-500 ring-1 ring-emerald-500" : "border-gray-200 dark:border-slate-600", "flex-shrink-0 w-16 h-16 border rounded-xl overflow-hidden bg-gray-50 dark:bg-slate-800 transition-all"])}">`);
            _push(ssrRenderComponent(_component_NuxtImg, {
              src: img.imageUrl,
              alt: unref(product).name,
...
//# sourceMappingURL=_slug_-CPAi5ZRO.mjs.map
