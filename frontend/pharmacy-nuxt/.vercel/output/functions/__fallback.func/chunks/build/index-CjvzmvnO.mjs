...
import { ssrRenderAttrs, ssrInterpolate, ssrRenderComponent, ssrRenderList, ssrRenderAttr, ssrRenderClass, ssrRenderTeleport, ssrIncludeBooleanAttr, ssrLooseContain, ssrLooseEqual } from 'vue/server-renderer';
import { u as useApi } from './index-BbS-CUl0.mjs';
import '../_/nitro.mjs';
import 'node:http';
import 'node:https';
import 'node:events';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(loading)) {
        ...
        ssrRenderList(unref(categories), (cat) => {
          ...
          if (cat.imageUrl) {
            _push(`<img${ssrRenderAttr("src", cat.imageUrl)}${ssrRenderAttr("alt", cat.name)} class="w-8 h-8 object-contain">`);
          } else {
            _push(ssrRenderComponent(_component_Icon, {
              name: "heroicons:tag",
...
//# sourceMappingURL=index-CjvzmvnO.mjs.map
