  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(unref(filteredProducts), (p) => {
        var _a;
        _push(`<tr class="hover:bg-gray-50 dark:hover:bg-slate-700/20 transition-colors"><td class="px-4 py-3.5"><div class="flex items-center gap-3">`);
...
//# sourceMappingURL=inventory-DzbIXsmx.mjs.map
